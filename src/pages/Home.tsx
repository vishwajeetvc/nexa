    ...
    <div className='--Cont flex w-full '>
      ...
      >
        <div className='--Top relative h-[50%]'>
          ...
          <img className="absolute left-[43%] top-[44%]" src={exa} />
          <img className="absolute left-[43%] top-[70%]" src={thePara} />
          <span className='inline-block w-[70px] h-[3px] absolute left-[46%] top-[76%] bg-red-500'></span>
          <div style={{
        ...
        <div className='--Bottom border-red-500 p-5'>
          ...
          <div className='text-white p-5'>
            <h1 className='text-4xl pb-3 font-bold text-[rgba(255,255,255,0.6)] '>Features :-</h1>
            <p className='font-extralight text-[rgba(255,255,255,0.3)]'>Real-time Screen Sharing, Real-time Video Calling
              File Sharing, Chatting.</p>
          </div>
          <div className='text-white p-5'>
            <h1 className='text-4xl pb-3 font-bold text-[rgba(255,255,255,0.6)] '>Creaters :-</h1>
            <p className='font-extralight text-[rgba(255,255,255,0.3)]'>Ankit, Javed, Kanhaiya, Prince, Vishwajeet</p>
          </div>
